 ...
 */
public abstract class BaseFragment<V extends ViewDataBinding, VM extends BaseViewModel> extends RxFragment implements IBaseActivity,ISupportFragment,ISwipeBackFragment {
    protected V binding;
    ...
    final SwipeBackFragmentDelegate mSwipeDelegate = new SwipeBackFragmentDelegate(this);
    @Override
    ...
    public SwipeBackLayout getSwipeBackLayout() {
        return mSwipeDelegate.getSwipeBackLayout();
    }
