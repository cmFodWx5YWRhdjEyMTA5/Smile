...
public class UploadHelper {
    ...
    // 上传的仓库名
    private static final String BUCKET_NAME = "smalltalk";
   ...
   public static long MAX_UPLOAD_IMAGE_LENGTH = 860 * 1024;
    ...
    private static OSS getClient() {
        ...
        OSSCredentialProvider credentialProvider = new OSSPlainTextAKSKCredentialProvider(
                "LTAIXFRRNiNMxUYA", "RkDeJeZDAlWGqCz7bKWFIaqPK5p5eT");
        return new OSSClient(BaseModuleInit.application, ENDPOINT, credentialProvider);
    }
