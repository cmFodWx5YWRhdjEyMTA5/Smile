...
import com.zzj.module_welfare.adapter.ViewPagerBindingAdapter;
...
public class ViewPagerViewModel extends BaseViewModel {
    ...
    public ItemBinding<ViewPagerItemViewModel> itemBinding = ItemBinding.of(BR.viewModel, R.layout.welfare_item_viewpager);
