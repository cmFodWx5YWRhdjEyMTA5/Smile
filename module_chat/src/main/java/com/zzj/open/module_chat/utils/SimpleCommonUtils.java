...
import com.zzj.open.module_chat.adapter.BigEmoticonsAdapter;
import com.zzj.open.module_chat.adapter.BigEmoticonsAndTitleAdapter;
import com.zzj.open.module_chat.adapter.TextEmoticonsAdapter;
import com.zzj.open.module_chat.view.SimpleAppsGridView;
...
//        etContent.addEmoticonFilter(new XhsFilter());
        ...
        return new EmoticonClickListener() {
            ...
            public void onEmoticonClick(Object o, int actionType, boolean isDelBtn) {
                if (isDelBtn) {
                    ...
                    if (actionType == Cons.EMOTICON_CLICK_TEXT) {
                        String content = null;
    ...
    public static void addEmojiPageSetEntity(PageSetAdapter pageSetAdapter, Context context, final EmoticonClickListener emoticonClickListener) {
        ...
        Collections.addAll(emojiArray, DefEmoticons.sDefEmojiArray);
                        ...
                        viewHolder.rootView.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                if (emoticonClickListener != null) {
                                    emoticonClickListener.onEmoticonClick(emojiBean, Cons.EMOTICON_CLICK_TEXT, isDelBtn);
                                }
                            }
                        });
                    }
    ...
    public static void addXhsPageSetEntity(PageSetAdapter pageSetAdapter, Context context, EmoticonClickListener emoticonClickListener) {
        EmoticonPageSetEntity xhsPageSetEntity
                ...
                .setIPageViewInstantiateItem(getDefaultEmoticonPageViewInstantiateItem(getCommonEmoticonDisplayListener(emoticonClickListener, Cons.EMOTICON_CLICK_TEXT)))
                .setShowDelBtn(EmoticonPageEntity.DelBtnStatus.LAST)
        ...
        return new EmoticonDisplayListener<Object>() {
            ...
            public void onBindView(int position, ViewGroup parent, EmoticonsAdapter.ViewHolder viewHolder, Object object, final boolean isDelBtn) {
                ...
                viewHolder.rootView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        if (emoticonClickListener != null) {
                            emoticonClickListener.onEmoticonClick(emoticonEntity, Cons.EMOTICON_CLICK_TEXT, isDelBtn);
                        }
                    }
                });
            }
