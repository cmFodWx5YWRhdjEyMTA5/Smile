...
public final class PicturesCompressor {
    ...
    public static boolean compressImage(Context context, final String srcPath,
                                        final String savePath,
                                        final long targetSize) {
        return compressImage(context,srcPath, savePath, targetSize, 75, 1280, 1280 * 6, null, null, true);
    }

    public static File loadWithGlideCache(Context context,String path) {
        File tmp;
        try {
    ...
    public static boolean compressImage(Context context,final String srcPath,
        ...
        if (inTmp.exists()) {
            ...
            File tmp = loadWithGlideCache(context,srcPath);
            if (tmp == null)
                return false;
            sourceFile = tmp;
            loadWithGlide = true;
        ...
        if (loadWithGlide) {
            ...
            realCacheFile = loadWithGlideCache(context,sourceFile.getAbsolutePath());
